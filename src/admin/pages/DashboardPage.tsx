...
const icons = {
  profile: <MdPerson className="w-5 h-5" />,
  experience: <MdWork className="w-5 h-5" />,
  projects: <MdFolder className="w-5 h-5" />,
  skills: <MdLightbulb className="w-5 h-5" />,
  blog: <MdArticle className="w-5 h-5" />,
  education: <MdSchool className="w-5 h-5" />,
  certification: <MdCardMembership className="w-5 h-5" />,
  publication: <MdMenuBook className="w-5 h-5" />,
  social: <MdLink className="w-5 h-5" />,
  gallery: <MdPhotoLibrary className="w-5 h-5" />,
  nav: <MdMenu className="w-5 h-5" />,
}
