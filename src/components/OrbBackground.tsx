...
export default function OrbBackground() {
  ...
  useEffect(() => {
    ...
    const observer = new MutationObserver(() => {
      ...
      const newBg = dark ? '#020617' : '#ffffff'
      program.uniforms.backgroundColor.value = hexToVec3(newBg)
    })
  ...
  return <div ref={ctnRef} className="fixed inset-0 z-0 pointer-events-none" />
}
